...
namespace ma.Providers
{
    public partial class MongoDBSimpleRoleProvider : RoleProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            mongoDatabase = mongoClient.GetServer().GetDatabase(new MongoUrl(uri).DatabaseName);
            ...
            usersInRolesMongoCollection.EnsureIndex("UserId");
        ...
        public override string[] GetRolesForUser(string username)
        {
            ...
            if (user != null)
            {
                ...
                if (roleUser != null)
                {
                    query = Query.In("_id", new BsonArray(roleUser.Select(p => p.RoleId)));
